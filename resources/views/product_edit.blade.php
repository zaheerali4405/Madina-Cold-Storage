    ...
    <div class="card bg-white">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3">Edit Product Details</h1>
            </div>
        </div>
    
        <form class="form" method= "POST" action="{{ route('update_product', $product->id) }}">
            @csrf;
            <!--Card body-->
                ...
                <div class="row g-4">
                    <div class="col-md-6 fv-row">
                        ...
                        <input class="form-control form-control-solid" placeholder="Please Enter Product Name"
                            name="product_name" value="{{ $product->name }}" type="text"/>
                    </div>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input class="form-control form-control-solid" placeholder="Please Enter Product Type"
                            name="product_type" value="{{ $product->type }}" type="text"/>
                    </div>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input class="form-control form-control-solid" placeholder="Please Enter Product Color"
                            name="product_color" value="{{ $product->color }}" type="text"/>
                    </div>
                </div>
            </div>
