...
@section('title') Edit Container @endsection
    ...
    <div class="card bg-white">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3">Edit Container Details</h1>
            </div>
        </div>
    
        <form class="form" method="POST" action="{{ route('update_container', $container->id) }}">
            @csrf;
            <!--Card body-->
                ...
                <div class="row g-4">
                    <div class="col-md-6 fv-row">
                        ...
                        <input class="form-control form-control-solid" placeholder="Please Enter Container Name"
                            name="container_name" value="{{ $container->name }}" type="text"/>
                    </div>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input class="form-control form-control-solid" placeholder="Please Enter Container Rent"
                            name="container_rent" value="{{ $container->rent }}" type="number"/>
                    </div>
                </div>
            </div>
